<template>
    ...
    <!-- 商品名称 -->
        ...
        <el-form-item label="商品价格"  prop="price">
            <el-input-number v-model="product.price" :min="0"  :step="0.1" placeholder="请输入商品价格" style="width: 30%;"></el-input-number>
        </el-form-item>
        <!-- 市场价格 -->
        <el-form-item label="市场价格" prop="marketPrice">
            <el-input-number v-model="product.marketPrice" :min="0" :step="0.1" label="市场价格" placeholder="请输入市场价格" style="width: 30%;"></el-input-number>
        </el-form-item>
        <!-- 库存 -->
        <el-form-item label="库存" prop="inventory" >
            <el-input-number v-model="product.inventory" :min="0"  label="库存" placeholder="请输入库存" style="width: 30%;"></el-input-number>
        </el-form-item>
    </el-form>
</template>
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const formRules = {
            ...
            marketPrice: [{ required: true, message: '请输入市场价格', trigger: 'blur' }],
